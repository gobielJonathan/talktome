...
export const USER_SEND_CHAT_EVENT = "user-send-chat";
...
export const USER_TOGGLE_HIGHLIGHT_EVENT = 'user-toggle-highlight'
...
export interface ListenerServerEvent { 
    ...
    [USER_SEND_CHAT_EVENT]: (userId: string, roomId: string, message: string) => void;
}
